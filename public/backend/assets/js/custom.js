window.addEventListener(
    ...
    function () {
        ...
        window.addEventListener("add_modal_event", (event) => {
            let add_modal = new bootstrap.Modal(
                document.querySelector("#add_modal")
            );
            add_modal.show();
        });
        ...
        window.addEventListener("show_modal_event", (event) => {
            let show_modal = new bootstrap.Modal(
        ...
        window.addEventListener("delete_modal_event", (event) => {
            ...
            if (event.detail.instance) {
                delete_modal_instance =
                    bootstrap.Modal.getOrCreateInstance(delete_modal);
